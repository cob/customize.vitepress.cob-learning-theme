//source:  https://github.com/vuejs/vitepress/blob/main/src/shared/shared.ts

// ** - declaration of types is not in the same place as in the original repo
// *** - we dont care about exporting types 


// import type { HeadConfig, PageData, SiteData } from '../../types/shared' [**]
import type { HeadConfig, PageData, SiteData } from './types'
