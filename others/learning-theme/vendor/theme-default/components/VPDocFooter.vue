...
import { hasAccess } from '../../../../vitepress/.vitepress/theme/utils/auth'
...
const hasEditLink = hasAccess(params.value?.restrictions)
const editLink = computed( () => `/recordm/#/instance/${params.value?.instance}`)
  ...
  <footer  class="VPDocFooter">
    ...
    <div class="edit-info">
      <div v-if="hasEditLink" class="edit-link">
        <VPLink class="edit-link-button" :href="editLink" :no-icon="true">
